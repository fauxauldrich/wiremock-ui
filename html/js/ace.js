(function () {
      ...
      g = function (e, t) {
        ...
        r.addListener(n, "compositionstart", U, t),
          ...
          (this.moveToMouse = function (e, o) {
            E || (E = n.style.cssText),
              (n.style.cssText =
                (o ? "z-index:100000;" : "") + (i.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (N + C) * t.renderer.characterWidth * 0.5 + "px;");
  ...
  define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event", "ace/tooltip"], function (
    e,
    t,
    n
  ) {
      ...
      c = function (e) {
        ...
        r.addListener(l, "mousedown", this.onMouseEvent.bind(this, "guttermousedown"), e),
          ...
          i.isIE &&
            ...
            (r.addListener(e.renderer.scrollBarV.element, "mousedown", n, e), r.addListener(e.renderer.scrollBarH.element, "mousedown", n, e)),
          e.on(
            "mousemove",
            function (n) {
  ...
  define("ace/mode/behaviour/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function (
    e,
    t,
    n
  ) {
  ...
  define("ace/document", ["require", "exports", "module", "ace/lib/oop", "ace/apply_delta", "ace/lib/event_emitter", "ace/range", "ace/anchor"], function (
    e,
    t,
    n
  ) {
    ...
    var r = e("./lib/oop"),
      ...
      a = function (e) {
        (this.$lines = [""]),
          e.length === 0 ? (this.$lines = [""]) : Array.isArray(e) ? this.insertMergedLines({ row: 0, column: 0 }, e) : this.insert({ row: 0, column: 0 }, e);
      };
    (function () {
      r.implement(this, s),
        ...
        (this.insertNewLine = function (e) {
          return (
            console.warn("Use of document.insertNewLine is deprecated. Use insertMergedLines(position, ['', '']) instead."), this.insertMergedLines(e, ["", ""])
          );
        }),
      ...
      function () {
        ...
        r.implement(this, u),
          ...
          (this.$clipRangeToDocument = function (e) {
            ...
            return (
              e.end.row > t ? ((e.end.row = t), (e.end.column = this.doc.getLine(t).length)) : (e.end.column = this.$clipColumnToRow(e.end.row, e.end.column)),
              e
            );
          }),
          (this.$wrapLimit = 80),
                    ...
                    (a = i),
                      ...
                      i &&
                        (i.type.indexOf("tag-name") !== -1
                          ? ((o = i.value), s === o && (a.value === "<" ? u++ : a.value === "</" && u--))
                          : s === o && i.value === "/>" && u--);
                  while (i && u >= 0);
                } else {
                  do {
      ...
      (this.$updateOpacity = function (e) {
        ...
        (this.getPixelPosition = function (e, t) {
          ...
          var n = this.session.documentToScreenPosition(e),
            r =
              this.$padding +
              (this.session.$bidiHandler.isBidiRow(n.row, e.row) ? this.session.$bidiHandler.getPosLeft(n.column) : n.column * this.config.characterWidth),
        ...
        (this.$setOverwrite = function (e) {
          e != this.overwrite &&
            ((this.overwrite = e), e ? r.addCssClass(this.element, "ace_overwrite-cursors") : r.removeCssClass(this.element, "ace_overwrite-cursors"));
        }),
        (this.destroy = function () {
    ...
    (function () {
      (this.CHANGE_CURSOR = 1),
        ...
        (this.$updateScrollBarV = function () {
          ...
          !this.$maxLines &&
            this.$scrollPastEnd &&
            ((e -= (t - this.lineHeight) * this.$scrollPastEnd), this.scrollTop > e - t && ((e = this.scrollTop + t), (this.scrollBarV.scrollTop = null))),
        ...
        (this.textToScreenCoordinates = function (e, t) {
          var n = this.scroller.getBoundingClientRect(),
            ...
            i =
              this.$padding +
              (this.session.$bidiHandler.isBidiRow(r.row, e) ? this.session.$bidiHandler.getPosLeft(r.column) : Math.round(r.column * this.characterWidth)),
    ...
    (function () {
      r.implement(this, s),
        (this.$createWorkerFromOldConfig = function (t, n, r, i, s) {
          ...
          return (
            (this.$worker = a(i)), s && this.send("importScripts", s), this.$worker.postMessage({ init: !0, tlns: f, module: n, classname: r }), this.$worker
          );
        }),
        ...
        (this.$sendDeltaQueue = function () {
          ...
          if (!e) return;
          (this.deltaQueue = null),
            e.length > 50 && e.length > this.$doc.getLength() >> 1 ? this.call("setValue", [this.$doc.getValue()]) : this.emit("change", { data: e });
        });
    }.call(f.prototype));
        ...
        (this.ranges = null),
          ...
          (this.addRange = function (e, t) {
            ...
            return (
              ...
              this.rangeCount > 1 &&
                ...
                (this._signal("multiSelect"), (this.inMultiSelectMode = !0), (this.session.$undoSelect = !1), this.rangeList.attach(this.session)),
          ...
          (this.$onRemoveRange = function (e) {
            ...
            this._signal("removeRange", { ranges: e }),
              this.rangeCount === 0 &&
                this.inMultiSelectMode &&
                ((this.inMultiSelectMode = !1), this._signal("singleSelect"), (this.session.$undoSelect = !0), this.rangeList.detach(this.session)),
              (t = t || this.ranges[0]),
      ...
      (this.updateSelectionMarkers = function () {
        ...
        (this.selectMore = function (e, t, n) {
          ...
          var o = r.getTextRange(s),
            u = h(r, o, e);
          u && ((u.cursor = e == -1 ? u.start : u.end), this.session.unfold(u), this.multiSelect.addRange(u), this.renderer.scrollCursorIntoView(null, 0.5)),
    ...
    (function () {
      (this.foldingStartMarker = null),
        ...
        (this.openingBracketBlock = function (e, t, n, i, s) {
          ...
          return (
            a == null && (a = e.getFoldWidget(u.row)), a == "start" && u.row > o.row && (u.row--, (u.column = e.getLine(u.row).length)), r.fromPoints(o, u)
          );
        }),
    ...
    (function () {
      (this.getRowLength = function (e) {
        ...
        (this.addLineWidget = function (e) {
          ...
          return (
            this.session._emit("changeFold", { data: { start: { row: e.row } } }), this.$updateRows(), this.renderWidgets(null, t), this.onWidgetChanged(e), e
          );
        }),
